  ...
  return (
    ...
    <div name='portfolio' className='bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-screen'>
       <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            <div className='pb-8'>        
                <p className='text-4xl font-bold inline border-b-4 border-blue-300'>Portfolio</p>
                <p className='py-6'>Check out some projects I've worked on</p>
            </div>
      

            <div className='mx-auto  grid sm:grid-cols-2 md:grid-cols-2 gap-5 px-12 sm:px-0'> 
